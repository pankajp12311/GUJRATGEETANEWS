...
<html lang="en">
	<head>
	    ...
	    <title>Nameenath Apparels</title>
		...
		<link rel="stylesheet" type="text/css" href="css/pankaj.css">
		<!-- Favicon -->
...
<br>
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix" >
			   <h3 class="new-product-title pull-center" align="center" style="font-size: 30px;">Featured Products</h3>  
				<ul class="nav nav-tabs nav-tab-line pull-left" id="new-products-1">
					<li class="active"  ><a href="#all" data-toggle="tab"><b>All</b></a></li>
					<li ><a href="#Mens" data-toggle="tab"><b>Mens</b></a></li>
					<li ><a href="#Womans" data-toggle="tab"><b>Womens</b></a></li>
				</ul><!-- /.nav-tabs -->
			</div>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Shirt</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Jeans</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
